...
/**
 * Full-bleed how-to video player WITH transport controls — Media3's native controller on
 * Android; the shared [TutorialPlayerControls] Compose overlay on iOS (play/pause, ±10s skip,
 * scrubber). Auto-plays [uri] once with sound; does not loop. Sibling to [VideoBackground] —
 * that one is decorative/no-controls, this one is the interactive tutorial surface. The caller
 * owns loading/error/retry around it.
 *
