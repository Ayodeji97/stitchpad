...
import stitchpad.composeapp.generated.resources.error_customer_cap_reached
...
fun CustomerError.toUiText(): UiText = when (this) {
    ...
    CustomerError.CAP_REACHED -> UiText.StringResourceText(Res.string.error_customer_cap_reached)
...
fun DataError.Network.toCustomerUiText(): UiText = when (this) {
    ...
    DataError.Network.CAP_REACHED -> UiText.StringResourceText(Res.string.error_customer_cap_reached)
