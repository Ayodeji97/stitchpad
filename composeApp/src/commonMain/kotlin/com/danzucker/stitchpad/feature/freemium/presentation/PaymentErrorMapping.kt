...
import stitchpad.composeapp.generated.resources.payment_error_missing_email
...
fun PaymentError.toUiText(): UiText = when (this) {
    ...
    PaymentError.MISSING_EMAIL -> UiText.StringResourceText(Res.string.payment_error_missing_email)
